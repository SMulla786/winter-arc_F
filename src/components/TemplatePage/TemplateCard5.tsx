...
const TemplateCard5 = ({template, setTemplate}: any) => {
  ...
  return (
    <div
      className={`relative h-40 w-full overflow-hidden rounded-xl text-white md:h-48 lg:h-56 xl:h-64 ${template === 'template5' ? 'ring-2 ring-blue-500' : ''}`}
      style={{
