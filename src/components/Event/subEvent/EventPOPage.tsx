...
import EventPoTable from './PO/EventPoTable';
import type {LineItem, PurchaseMaterialData, Vendor} from './eventHelper';
import {
  extractLastPrices,
  formatDateForAPI,
  formatDateForInput,
...
import POHeaderButtons from './POHeaderButtons';

const EventPoPage: React.FC = () => {
    ...
    <div>
      <div className="mt-2 rounded-md px-4">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          {/* Buttons */}
          <POHeaderButtons setShowHistoryModal={setShowHistoryModal} />
        </div>
      </div>
