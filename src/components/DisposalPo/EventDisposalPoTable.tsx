...
import CategoryHeaderDisposal from './CategoryHeaderDisposal';
import LineItemRowdisposal from './LineItemRowdisposal';
import BreakdownRowDisposal from './BreakDownRowdisposal';
import {LineItem} from './Disposlaeventhelper';
...
const EventDisposalPoTable: React.FC<EventPoTableProps> = ({
  groupedItems,
  expandedCategories,
  expandedBreakdowns,
  categoryConfigs,
            ...
            <h3 className="text-gray-800 text-lg font-semibold dark:text-white">
              {isViewMode && currentPoStatus === 'COMPLETED'
                ...
                : currentPoStatus === 'PARTIAL'
                  ? 'Edit Draft Disposal PO'
                  : 'Create New Disposal PO'}{' '}
              (
...
export default EventDisposalPoTable;
