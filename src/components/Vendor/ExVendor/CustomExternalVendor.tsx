...
import {Route} from '@/routes/customvendor_tender.$name.$id';
...
const CustomExternalVendor: React.FC = () => {
  const paramsData = Route.useParams();
  const search = useSearch({
    from: '/customvendor_tender/$name/$id',
  });
...
export default CustomExternalVendor;
