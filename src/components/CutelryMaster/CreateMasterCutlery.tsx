...
import CutleryCat from './CutleryCreate';
import DisplayCutleryCreate from './DisplayCreateCutlery';
import CutleryCreate from './CutleryCreate';

const CreateMasterCutlery: React.FC = () => {
...
export default CreateMasterCutlery;
