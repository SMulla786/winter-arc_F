...
interface CustomRMHistoryDetailProps {
  historyId: string;
  onBack: () => void;
...
const CustomRMHistoryDetail: React.FC<CustomRMHistoryDetailProps> = ({
  historyId,
  onBack,
  activeTab,
  onTabChange,
          ...
          <div className="overflow-hidden rounded-xl border border-stroke bg-white shadow-sm dark:border-strokedark dark:bg-meta-4">
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-stroke dark:divide-strokedark">
                ...
                <tbody className="divide-y divide-stroke bg-white dark:divide-strokedark dark:bg-meta-4">
                  {tenderData.categories.length === 0 ? (
                    <tr>
                      <td
                            ...
                            categoryItems.map((item, index) => {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  {tenderData.vendorList.map((vendor: any) => {
                                    const priceData = item.prices.get(
                                      vendor.id,
                                    );
...
export default CustomRMHistoryDetail;
