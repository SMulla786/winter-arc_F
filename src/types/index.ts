...
export interface CreateDishRawMaterial extends Omit<
  CaterorDishRawMaterial,
  'CaterorID'
> {
  token?: string;
...
export interface PredictRawMaterialQuantity extends Omit<
  CaterorDishRawMaterial,
